...
inline void processInput(GLFWwindow *window, unsigned int &curtex, unsigned int maxtex) {
...
inline void draw(float *data, int slice, int width, int height, int depth) {
    glfwInit();
