...
void forward_3d_cuda(
    nb::ndarray<curad::f32, nb::shape<-1, -1, -1>, nb::device::cuda, nb::c_contig> x,
    ...
    nb::ndarray<curad::f32, nb::shape<-1, -1, -1>, nb::device::cuda, nb::c_contig> y,
...
void forward_2d_cuda(nb::ndarray<nb::shape<-1, -1>, nb::device::cuda, nb::c_contig> x,
                     nb::ndarray<nb::shape<-1, -1>, nb::device::cuda, nb::c_contig> y,
                     curad::plan_2d &plan);
