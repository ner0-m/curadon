...
void add_plan(nb::module_ &m) {
    nb::class_<curad::forward_plan_2d>(m, "forward_plan_2d")
        ...
        .def("__init__", [](curad::forward_plan_2d *plan, curad::usize device,
                            ...
                            curad::u64 det_count, curad::f32 det_spacing, curad::f32 det_offset,
                            curad::f32 DSO, curad::f32 DSD,
            ...
            new (plan) curad::forward_plan_2d(device, vol_shape, vol_spacing, vol_offset, det_count,
                                              det_spacing, det_offset, DSO, DSD, owning_angles,
                                              det_pitch, COR);
        });
}
